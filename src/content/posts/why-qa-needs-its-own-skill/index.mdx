...
description: A workflow for the part of shipping that tests cannot reach. In the AI era, code production has multiplied but verification has not, and a skill is needed to capture what to verify.
pubDate: 2026-08-31
tags: [qa, ai, workflow, skills]
lang: en
draft: false
ogImage: ./images/plan-execute-split-og.webp
---
