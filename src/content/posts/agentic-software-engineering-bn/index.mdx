...
একটা বাস্তবতা এখানেই বলে রাখা দরকার। Claude, ChatGPT, Lovable — এসবের subscription কিনতে গেলে প্রায়ই international card লাগে, আর সরাসরি BDT দিয়ে কেনার রাস্তা নেই। কিন্তু এই পুরো Phase 1 আসলে free tier দিয়েই চলে যায় — Claude আর ChatGPT দুটোরই usable free version আছে, আর Lovable বা Stitch-এ শুরুতে যথেষ্ট free credit থাকে একটা concept prototype বানানোর জন্য। Card সত্যিই লাগলে Wise বা Payoneer-এর USD virtual card, বা bKash-লিংকড local virtual-card service গুলো কাজে লাগে — এখন অনেক BD engineer এভাবেই চালান। মূল কথা হলো, টাকার অভাবে এই process আটকায় না; আটকায় শুধু কোন tool কোথায় free দিচ্ছে সেটা না জানলে।
...
> Software engineering-এর একজন বহু-পরিচিত veteran সম্প্রতি এই ধাঁচের একটা post দিয়েছেন: তিনি আর code পড়েন না। তিনি test আর drill গুলো এমনভাবে বসিয়ে দেন যাতে agent-এর কাছে তিনি যা চান তার বাইরে কিছু produce করার কোনো রাস্তাই না থাকে। তাঁর যুক্তিটাই আমার মাথায় গেঁথে গেছে: syntax পড়তে বসলে তিনি agent-এর output-এর সাথে তাল মেলাতে পারেন না। পড়াটাই bottleneck, তাই তিনি review বাড়ানোর বদলে constraint বাড়ান। কয়েক দশক ধরে code quality নিয়ে যিনি সবচেয়ে জোরে সোচ্চার ছিলেন, তিনি নিজেই যে এই সিদ্ধান্তে পৌঁছেছেন — সেটা মাথায় রেখে একটু ভেবে দেখুন কথাটা।
...
এর কোনোটাই exotic কিছু না। এটা least privilege — বিশ বছর ধরে service-এর ক্ষেত্রে আমরা এটাই করে আসছি, আর যেই জিনিসটাকে access দিচ্ছি সেটা পুরো বাক্যে উত্তর দেওয়া শুরু করল, অমনি ভুলে গেলাম। OWASP (যে non-profit organization industry-standard security guideline লেখে) AI agent নিয়ে যা বলছে সেটাও একই জায়গায় এসে দাঁড়ায় — minimum tool, scoped permission, sensitive কিছুর জন্য explicit authorisation।
...
Instrumentation feature-এরই অংশ হিসেবে করুন, পরে পরিষ্কার করার কাজ হিসেবে না। Trace, metric, log — production-এ কী ঘটছে সেটা measure করার তিনটা standard signal, যেগুলোর জন্য OpenTelemetry সবচেয়ে বহুল-ব্যবহৃত tool — আর ওগুলোকে release-এর সাথে *আর* Phase 04-এ লেখা acceptance criteria-র সাথে correlate করুন। ওই correlation-টাই আসল কথা। ওটা দিয়েই আপনি জানবেন, যেটা আপনি specify করেছিলেন সেটাই মানুষ পেয়েছে কি না।
