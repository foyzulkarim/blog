...
lang: en
draft: false
ogImage: ./og-dos-donts-v1.webp
---

import Figure from '@components/Figure.astro';

![Hero card: "The DOs and DON'Ts" — what auditing 1,000+ of the author's own AI coding sessions taught him about where the tokens actually go, with "/session-audit" in gold inside a side panel.](./og-dos-donts-v1.webp)
